...
Not included (deferred):
  ...
  * Curve Atlas driven pulse — a ``UCurveLinearColorAtlas`` +
    ...
    tether C++ UFUNCTION to expose FRichCurve::AddKey.
...
def build(master_path: str = "/Game/TetherTemplates/M_Weapon_Hero",
          mi_path: Optional[str] = "/Game/TetherTemplates/MI_Weapon_Hero_Test",
    ...
    # ---------- POM MF call wiring --------------------------------------
    # MF input pin names (with spaces) — tether NormalizePinName handles the
