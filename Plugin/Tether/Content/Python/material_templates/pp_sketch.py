...
Composites three classic sketch layers over posterized scene colour:
  ...
  1. Depth-edge outline (4-neighbour depth gradient via TetherSobelEdge)
  2. Luminance-driven cross-hatching (4 direction layers via TetherCrossHatch)
...
def build(master_path: str = "/Game/TetherTemplates/PP_Sketch",
          apply_to_volume: str = "",
    ...
    sobel = L.add_custom_expression(
        ...
        "Float1",
        "return TetherSobelEdge(dL, dR, dU, dD, Threshold, Gain);",
    ...
    hatch = L.add_custom_expression(
        ...
        "Float1",
        "return TetherCrossHatch(UV, Luminance, Frequency);",
        ["/Plugin/Tether/TetherSnippets.ush"],
        "Cross-hatch shading")
