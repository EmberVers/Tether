...
class Property:
    ...
    def array_append_u_property(*, object_or_class_path, property_path, element_export_text, fire_change_notify=True):
        ...
        return unreal.TetherPropertyLibrary.array_append_u_property(object_or_class_path, property_path, element_export_text, fire_change_notify)
    ...
    def array_clear_u_property(*, object_or_class_path, property_path, fire_change_notify=True):
        ...
        return unreal.TetherPropertyLibrary.array_clear_u_property(object_or_class_path, property_path, fire_change_notify)
    ...
    def array_remove_u_property(*, object_or_class_path, property_path, index, fire_change_notify=True):
        ...
        return unreal.TetherPropertyLibrary.array_remove_u_property(object_or_class_path, property_path, index, fire_change_notify)
    ...
    def set_u_property_from_export_text(*, object_or_class_path, property_path, value_export_text, fire_change_notify=True):
        ...
        return unreal.TetherPropertyLibrary.set_u_property_from_export_text(object_or_class_path, property_path, value_export_text, fire_change_notify)
