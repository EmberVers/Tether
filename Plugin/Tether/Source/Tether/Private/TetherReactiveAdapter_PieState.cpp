...
DEFINE_LOG_CATEGORY_STATIC(LogTetherReactivePie, Log, All);
 ...
 */
class FTetherPieStateAdapter : public ITetherReactiveAdapter
{
public:
...
private:
	...
	void FirePhase(const TCHAR* PhaseName, bool bIsSimulating)
	{
		...
		Sub->Dispatch(ETetherTrigger::PieEvent,
...
namespace TetherReactiveAdapters
{
	...
	{
		return MakeUnique<FTetherPieStateAdapter>();
	}
}
