// TetherCompat.h — cross-version compatibility shims for the tether plugin.
...
// `FTetherJsonAttrsKey(*StringValue)` when inserting.
#if !UE_VERSION_OLDER_THAN(5, 8, 0)
#include "Containers/SharedString.h"
using FTetherJsonAttrsKey = UE::FSharedString;
#else
using FTetherJsonAttrsKey = FString;
#endif
