// Copyright Tether. Shared type-string ↔ FEdGraphPinType helpers.
//
// Used by TetherBlueprintLibrary (variable / parameter / member type
// CRUD) and TetherStructLibrary (UserDefinedStruct field CRUD). The
...
// extends every tether surface that accepts type_string.
#pragma once

#include "CoreMinimal.h"
#include "EdGraph/EdGraphPin.h"

namespace TetherTypeParseImpl
{
