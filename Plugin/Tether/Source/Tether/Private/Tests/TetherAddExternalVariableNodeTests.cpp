...
namespace TetherAddExternalVariableNodeTests
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FTetherAddExternalVariableNodeTransientTest,
	"Tether.Blueprint.AddExternalVariableNode.Transient",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTetherAddExternalVariableNodeTransientTest::RunTest(const FString& Parameters)
{
	using namespace TetherAddExternalVariableNodeTests;
	(void)Parameters;
	...
	GEditor->ResetTransaction(NSLOCTEXT(
		"TetherTests", "AddExternalVariableResetBefore",
	...
	ON_SCOPE_EXIT
	{
		...
		{
			GEditor->ResetTransaction(NSLOCTEXT(
				"TetherTests", "AddExternalVariableResetAfter",
	...
	const FString GetterGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString SetterGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString PrivateGetterGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString PrivateSetterGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString ReadOnlyGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString MissingPropertyGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
	...
	const FString MissingClassGuid = UTetherBlueprintLibrary::AddExternalVariableNode(
