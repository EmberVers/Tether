...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FTetherCompileBlueprintsStructuralInvalidationTest,
	"Tether.Editor.CompileBlueprints.StructuralInvalidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTetherCompileBlueprintsStructuralInvalidationTest::RunTest(const FString& Parameters)
{
	const FString PackagePath = FString::Printf(
		TEXT("/Temp/TetherCompileBlueprints_%s"),
	...
	UBlueprint* Blueprint = FKismetEditorUtilities::CreateBlueprint(
		...
		TEXT("TetherCompileBlueprintsTests"));
	...
	const FName ReflectedMemberName(TEXT("TetherStructuralMember"));
	if (!TestNotNull(
	...
	const TArray<FTetherCompileResult> Results =
		UTetherEditorLibrary::CompileBlueprints(BlueprintPaths);
