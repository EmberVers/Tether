...
#include "TetherDataTableLibrary.generated.h"

/** A single row in a DataTable. */
USTRUCT(BlueprintType)
struct FTetherDataTableRow
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly, Category = "Tether|DataTable")
	FString RowName;
...
USTRUCT(BlueprintType)
struct FTetherDataTableImportResult
{
	GENERATED_BODY()
...
struct FTetherDataTableInfo
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|DataTable")
	TArray<FTetherDataTableRow> Rows;
};

/**
 * DataTable introspection and editing via Tether.
 */
UCLASS()
class TETHER_API UTetherDataTableLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableInfo GetDataTableRows(const FString& DataTablePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableInfo GetDataTableSummary(const FString& DataTablePath);
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableRow GetDataTableRow(const FString& DataTablePath, const FString& RowName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableInfo GetDataTableRowsFiltered(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableImportResult ImportDataTableFromCSVText(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableImportResult ImportDataTableFromJSONText(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableImportResult CreateDataTableFromCSV(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static FTetherDataTableImportResult CreateDataTableFromJSON(
		const FString& AssetPath,
		const FString& RowStructPath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
	static TArray<FTetherDataTableColumn> GetDataTableColumnTypes(const FString& DataTablePath);

	/**
	 * Return a single row as a FieldName -> exported-text map.
	 * More convenient for programmatic use than FTetherDataTableRow's flat "name = value" list.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|DataTable")
