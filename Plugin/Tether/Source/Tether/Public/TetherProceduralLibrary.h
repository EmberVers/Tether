...
#include "TetherProceduralLibrary.generated.h"
 ...
 *    TetherLevelLibrary trace family for cross-call consistency.
 *  - Hard cap on points: 100k per call. Above that → return empty + log.
 *    The 100k+ scale belongs to PCG, not to this tether layer.
 */
UCLASS()
class TETHER_API UTetherProceduralLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Procedural")
	 ...
	 * `TetherLevelLibrary.cpp::AddComponentOfClass` for the canonical pattern.
	 *
