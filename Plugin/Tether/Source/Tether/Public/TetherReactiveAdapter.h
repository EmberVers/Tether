...
class UTetherReactiveSubsystem;
 ...
 */
class ITetherReactiveAdapter
{
public:
	virtual ~ITetherReactiveAdapter() = default;
	 ...
	 */
	virtual void OnHandlerAdded(const FTetherHandlerRecord& Record) = 0;
	 ...
	 */
	virtual void OnHandlerRemoved(const FTetherHandlerRecord& Record) = 0;
