...
#include "TetherNavigationLibrary.generated.h"
 ...
 */
UCLASS()
class UTetherNavigationLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Navigation")
