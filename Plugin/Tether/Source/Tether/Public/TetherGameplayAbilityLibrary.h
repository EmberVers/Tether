...
#include "TetherGameplayAbilityLibrary.generated.h"

/** Overview of a UGameplayAbility Blueprint (read from CDO). */
USTRUCT(BlueprintType)
struct FTetherGameplayAbilityInfo
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility")
	FString Name;
...
USTRUCT(BlueprintType)
struct FTetherGameplayEffectInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility")
	TArray<FTetherGEModifierInfo> Modifiers;
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility")
	TArray<FTetherGEComponentInfo> Components;
};
...
USTRUCT(BlueprintType)
struct FTetherAttributeSetInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility")
	TArray<FTetherAttributeInfo> Attributes;
};

/** Live attribute value read from an ASC. */
USTRUCT(BlueprintType)
struct FTetherAttributeValue
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherAbilityCooldownInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherActiveEffectInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherGrantedAbilityInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherActorAbilitySystemInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility")
	TArray<FTetherGrantedAbilityInfo> GrantedAbilities;
...
USTRUCT(BlueprintType)
struct FTetherAbilityTagRequirements
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherAbilityTriggerInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherActiveAbilityInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherTagReference
{
	GENERATED_BODY()

	/** Asset object path, e.g. "/Game/GA/BP_Foo.BP_Foo". */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString AssetPath;

	/** "Blueprint" / "DataTable" / "DataAsset" / etc. — short class name of the asset. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString AssetClass;
	 ...
	 *   "Pin: TagPin"
	 */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString Location;

	/**
	 * Extra context — for BP graph hits: "Graph: <name>, Node: <title>".
	 * For DataTable rows: "Row: <name>". For CDO scans: "CDO".
	 */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString Context;

	/** The actual tag string found (may be a child of TagQuery when bMatchExact=false). */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString MatchedTag;
};

/** Aggregate report from FindGameplayTagReferences. */
USTRUCT(BlueprintType)
struct FTetherTagReferenceReport
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") FString TagQuery;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") bool bMatchExact = true;

	/** Number of assets walked (may be < total under PackagePath if MaxResults hit). */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") int32 AssetsScanned = 0;

	/** Number of distinct assets that contained at least one match. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") int32 AssetsMatched = 0;

	/** Total reference rows in `References` (may be capped at MaxResults). */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") int32 ReferenceCount = 0;

	/** True when the scan stopped because MaxResults was reached. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") bool bTruncated = false;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") float ScanDurationMs = 0.f;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayAbility") TArray<FTetherTagReference> References;
};

/**
 * GameplayAbilitySystem introspection via Tether.
 */
UCLASS()
class TETHER_API UTetherGameplayAbilityLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherGameplayAbilityInfo GetGameplayAbilityBlueprintInfo(const FString& AbilityBlueprintPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherGameplayEffectInfo GetGameplayEffectBlueprintInfo(const FString& EffectBlueprintPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherAttributeSetInfo GetAttributeSetInfo(const FString& AttributeSetClassPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherActorAbilitySystemInfo GetActorAbilitySystemInfo(const FString& ActorName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherAttributeValue GetAttributeValue(const FString& ActorName, const FString& AttributeName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static TArray<FTetherActiveEffectInfo> GetActorActiveEffects(const FString& ActorName, int32 MaxResults);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherAbilityCooldownInfo GetAbilityCooldownInfo(
		const FString& ActorName,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static TArray<FTetherActiveEffectInfo> FindActiveEffectsByTag(
		const FString& ActorName,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static TArray<FTetherAttributeValue> GetActorAttributes(const FString& ActorName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherAbilityTagRequirements GetAbilityTagRequirements(const FString& AbilityBlueprintPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static TArray<FTetherAbilityTriggerInfo> GetAbilityTriggers(const FString& AbilityBlueprintPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static TArray<FTetherActiveAbilityInfo> GetActorActiveAbilities(const FString& ActorName);
	...
	/**
	 * Test scaffolding: ensure the actor has a UTetherTestAttributeSet (Health+Mana)
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static bool EnsureTetherTestAttributeSet(const FString& ActorName);

	/**
	 * Set a numeric attribute on the actor's ASC via SetNumericAttributeBase.
	 * Fires the attribute-value-change delegate that FTetherAttributeChangedAdapter
	 ...
	 * UFUNCTIONs to build a complete ability from scratch in one tether
	 * session.
	 *
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayAbility")
	static FTetherTagReferenceReport FindGameplayTagReferences(
		const FString& TagQuery,
