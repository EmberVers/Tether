...
#include "TetherPerfLibrary.generated.h"
...
struct FTetherFrameTiming
{
	GENERATED_BODY()

	/** Engine's running-average FPS (GAverageFPS). 0 before the first full frame. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	float Fps = 0.f;
...
USTRUCT(BlueprintType)
struct FTetherUObjectClassCount
{
	GENERATED_BODY()
...
struct FTetherUObjectStats
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherUObjectClassCount> TopClasses;
};

/**
 * Aggregated row for memory / asset / actor breakdown queries on
 * `UTetherPerfLibrary`. `Key` is the group identifier (folder path,
 ...
 */
USTRUCT(BlueprintType)
struct FTetherPerfBreakdownRow
{
	GENERATED_BODY()
 ...
 * accumulated by `TetherPerfFrameHook` (registered at module startup, hooked
 ...
 * Logged by `TetherPerfFrameHook` into a small ring buffer; `GetHitchLog`
 * filters by threshold and returns the most recent entries.
 */
USTRUCT(BlueprintType)
struct FTetherHitchEntry
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherPerfSamplingState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherPerfSnapshot
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	FTetherFrameTiming Timing;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	FTetherRenderCounters Render;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	FTetherMemoryStats Memory;

	/** Populated only when bIncludeUObjectStats was true. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	FTetherUObjectStats UObjects;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherMaterialRenderRow
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherLumenDiagnostics
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherTraceStartResult
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherTraceChannelInfo
{
	GENERATED_BODY()
...
/** One row of `FTetherPerfTraceSummary::HotScopes` (M4-5). */
USTRUCT(BlueprintType)
struct FTetherPerfHotScope
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherInsightsLaunchResult
{
	GENERATED_BODY()
...
/**
 * Per-field delta between two `FTetherPerfSnapshot` instances (M8-2).
 ...
 */
USTRUCT(BlueprintType)
struct FTetherPerfSnapshotDelta
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherPerThreadHotScopes
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfHotScope> TopScopes;
};

/** Result of `parse_trace_to_summary` (M4-5). */
USTRUCT(BlueprintType)
struct FTetherPerfTraceSummary
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfHotScope> HotScopes;
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfHotScope> GpuHotScopes;
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerThreadHotScopes> PerThreadHotScopes;
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfCounter> Counters;
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfLoadTimeRow> LoadTimeBreakdown;
...
USTRUCT(BlueprintType)
struct FTetherPerfNetConnection
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherPerfNetGameInstance
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfNetConnection> Connections;
};

/** One streaming-texture row (M7-1). */
USTRUCT(BlueprintType)
struct FTetherTextureStreamingRow
{
	GENERATED_BODY()
 ...
 * tether plugin's lean dependency set.
 */
USTRUCT(BlueprintType)
struct FTetherMaterialPerfRow
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherAllMaterialsAnalysis
{
	GENERATED_BODY()
...
struct FTetherGpuPassTimings
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherGpuPassTiming> Passes;
...
USTRUCT(BlueprintType)
struct FTetherRenderTargetEntry
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherRenderTargetMemory
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherRenderTargetEntry> Entries;
};

/** Result of `get_texture_streaming_residency` (M7-1). */
USTRUCT(BlueprintType)
struct FTetherTextureStreamingState
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherTextureStreamingRow> Rows;
};
/** One cooked-package row (M6-3). */
USTRUCT(BlueprintType)
struct FTetherPerfCookRow
{
	GENERATED_BODY()
...
struct FTetherPerfCookSummary
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfCookRow> Packages;
...
struct FTetherPerfNetSummary
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfNetGameInstance> GameInstances;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherPerfAllocSummary
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Perf")
	TArray<FTetherPerfAllocTag> Tags;
...
/**
 * Structured performance snapshots for Tether. Replaces parsing
 * `stat unit` text output. All values are read from engine globals + platform
 * APIs on the GameThread.
 */
UCLASS()
class TETHER_API UTetherPerfLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 * this.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherFrameTiming GetFrameTiming();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherRenderCounters GetRenderCounters();

	/** Return process + system memory stats in MiB. */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherMemoryStats GetMemoryStats();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherUObjectStats GetUObjectStats(int32 TopN = 20);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfSnapshot GetPerfSnapshot(bool bIncludeUObjectStats = false, int32 UObjectTopN = 20);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetWorldActorBreakdown(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetTextureMemoryBreakdown(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetMeshMemoryBreakdown(
		const FString& GroupBy,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetUObjectMemoryBreakdown(int32 TopN = 20);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetAudioMemoryBreakdown(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetAssetSizeTopN(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherHistogramBucket> GetFrameTimeHistogram(
		float BucketMs = 5.f,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherHitchEntry> GetHitchLog(
	 ...
	 * fires every `PeriodMs` and captures a `FTetherPerfSnapshot` into a
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfSnapshot> StopPerfSampling();

	/** Return the active / inactive state of the periodic sampler. */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfSamplingState GetPerfSamplingState();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherMaterialRenderRow> GetVisiblePrimitivesByMaterial(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherActorRenderCost GetActorRenderCost(const FString& ActorPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherPerfBreakdownRow> GetLodDistribution(
		const FString& ClassFilter,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherActorRenderCost> GetShadowCasterBreakdown(int32 TopN = 30);
	 ...
	 * See FTetherLumenDiagnostics for what's surfaced and why surface-cache
	 * / probe-count internals stay unimplemented.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherLumenDiagnostics GetLumenDiagnostics();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherNaniteStats GetNaniteStats();
	 ...
	 *   - empty → <Project>/Saved/Tether/Traces/<unix_ts>.utrace
	 *   - directory → that directory + the auto-named file
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherTraceStartResult StartTraceCapture(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherTraceStopResult StopTraceCapture();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherTraceState GetTraceState();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherTraceChannelInfo> ListTraceChannels();
	 ...
	 * Synchronous, blocks the tether exec; for large traces, kick this from
	 ...
	 * @return                 FTetherPerfTraceSummary with `bSuccess=true` on
	 *                         success, or `bSuccess=false` + populated `Error`
	 *                         on any failure (file missing, module load fail,
	 *                         unparseable trace).
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfTraceSummary ParseTraceToSummary(
	 ...
	 * budget; Analyze is synchronous and blocks the tether exec.
	 *
	 * @param UtracePath  Absolute path to a `.utrace` file. Must exist.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfAllocSummary ParseAllocTraceToSummary(const FString& UtracePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfNetSummary ParseNetTraceToSummary(const FString& UtracePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherTextureStreamingState GetTextureStreamingResidency(int32 TopN = 30);

	/**
	 * Render-target memory aggregate (M7-2). See `FTetherRenderTargetMemory`
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherRenderTargetMemory GetRenderTargetMemory(int32 TopN = 30);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherGpuPassTimings GetPerPassGpuTimings();
	 ...
	 * MaterialEditor module which is intentionally not a tether dependency).
	 *
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherAllMaterialsAnalysis AnalyzeAllMaterials(int32 TopN = 30);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfCookSummary ParseCookTraceToSummary(const FString& UtracePath, int32 TopN = 50);

	/**
	 * Diff two `FTetherPerfSnapshot` instances (M8-2). Returns deltas for
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherPerfSnapshotDelta ComparePerfSnapshots(
	 ...
	 * (Insights runs as its own process); the tether call returns as soon as
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherInsightsLaunchResult BeginInsightsForTrace(const FString& UtracePath);
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static TArray<FTetherAutoHitchEntry> EndAutoHitchCapture();

	/** Query auto-hitch capture state (M8-1). */
	UFUNCTION(BlueprintCallable, Category = "Tether|Perf")
	static FTetherAutoHitchState GetAutoHitchState();
};
