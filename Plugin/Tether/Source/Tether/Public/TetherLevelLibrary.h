...
#include "TetherLevelLibrary.generated.h"

// ─── Transform ──────────────────────────────────────────────
USTRUCT(BlueprintType)
struct FTetherTransform
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Level")
...
// ─── Component info ─────────────────────────────────────────
USTRUCT(BlueprintType)
struct FTetherLevelComponentInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Level")
	FTetherTransform RelativeTransform;
};

// ─── Actor info (detailed) ──────────────────────────────────
USTRUCT(BlueprintType)
struct FTetherActorInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Level")
	TArray<FTetherLevelComponentInfo> Components;
...
/**
 * Level / actor introspection via Tether. Operates on the editor world.
 */
UCLASS()
class TETHER_API UTetherLevelLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherLevelSummary GetLevelSummary();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherActorBrief> ListActors(
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherActorInfo GetActorInfo(const FString& ActorName);

	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherTransform GetActorTransform(const FString& ActorName);

	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherLevelComponentInfo> GetActorComponents(const FString& ActorName);
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherStreamingLevel> GetStreamingLevels();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherPropertyInfo> ListActorProperties(const FString& ActorName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherPropertyInfo> ListClassProperties(const FString& ClassPath);
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static TArray<FTetherActorRadiusHit> FindActorsInRadius(FVector Location, float Radius, const FString& ClassFilter);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherActorBounds GetActorBounds(const FString& ActorName);
	...
	// across tether exec calls) and can be serialised to JSON for reuse
	// across sessions.
	//
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level|NavGraph")
	 ...
	 * free navigation.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level|Vision")
	...
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherTransform GetSocketWorldTransform(const FString& ActorName, const FString& ComponentName, const FName SocketName);

	/** World transform of a scene component by name. Returns identity if not found. */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherTransform GetComponentWorldTransform(const FString& ActorName, const FString& ComponentName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherActorBounds GetLevelBounds();
	 ...
	 * Editor-world variant of `tether-gameplay-api.get_pawn_ground_height`.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Level")
	static FTetherActorBounds GetSelectionBounds();
