...
#include "TetherGameplayTagLibrary.generated.h"
...
struct FTetherTagSourceInfo
{
	GENERATED_BODY()

	/** The tag string the lookup was performed for. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|GameplayTag")
	FString TagString;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherTagSourceListing
{
	GENERATED_BODY()
	...
	/** True if the tether mutation APIs (AddGameplayTag / RenameGameplayTag /
 ...
 */
USTRUCT(BlueprintType)
struct FTetherTagRedirectEntry
{
	GENERATED_BODY()
 ...
 * project-defined named values) use TetherAssetLibrary directly:
 * find_assets_referencing_searchable_name / get_searchable_names_used_by_asset.
 */
UCLASS()
class TETHER_API UTetherGameplayTagLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayTag")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayTag")
	static FTetherTagSourceInfo GetTagSourceInfo(const FString& TagString);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayTag")
	static TArray<FTetherTagSourceListing> ListTagSourceInis(const FString& FilterType = TEXT(""));
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|GameplayTag")
	static TArray<FTetherTagRedirectEntry> ListGameplayTagRedirects(
