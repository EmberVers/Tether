...
#include "TetherMaterialLibrary.generated.h"

/** 材质实例上一个具有完整身份和值的参数覆盖。 / A parameter override on a material instance with its complete identity and value. */
USTRUCT(BlueprintType)
struct FTetherMaterialParam
{
	GENERATED_BODY()

	/** 参数名称。 */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	FString Name;
...
USTRUCT(BlueprintType)
struct FTetherMaterialInstanceInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParam> Parameters;
};
 ...
 */
USTRUCT(BlueprintType)
struct FTetherMaterialLayerEntry
{
	GENERATED_BODY()

	/** 槽位索引，必须从零开始并与数组顺序一致。 */
	UPROPERTY(BlueprintReadWrite, Category = "Tether|Material")
	int32 Index = 0;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherMaterialLayerStack
{
	GENERATED_BODY()
	...
	/** 按 Index 升序排列的完整可见栈。 */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialLayerEntry> Layers;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherMaterialLayerStackOpResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialParamDefault
{
	GENERATED_BODY()
...
struct FTetherMaterialInfo
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParamDefault> ScalarParameters;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParamDefault> VectorParameters;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParamDefault> TextureParameters;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParamDefault> StaticSwitchParameters;
...
USTRUCT(BlueprintType)
struct FTetherMaterialFunctionPort
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialFunctionSummary
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialFunctionInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialFunctionPort> Inputs;

	/** Sorted by SortPriority ascending. */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialFunctionPort> Outputs;
...
USTRUCT(BlueprintType)
struct FTetherMaterialInstanceLayer
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialParam> OverrideParameters;
};

/** Result of walking an MI up to its UMaterial base. */
USTRUCT(BlueprintType)
struct FTetherMaterialInstanceChain
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialInstanceLayer> Layers;
};

/** Scalar entry on a UMaterialParameterCollection. */
USTRUCT(BlueprintType)
struct FTetherMPCScalarParam
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialParameterCollectionInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMPCScalarParam> ScalarParameters;

	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMPCVectorParam> VectorParameters;
};

/** One expression node in a material or material function graph. */
USTRUCT(BlueprintType)
struct FTetherMaterialGraphNode
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialGraphConnection
{
	GENERATED_BODY()
...
struct FTetherMaterialStats
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialShaderStat> Shaders;
 ...
 */
USTRUCT(BlueprintType)
struct FTetherShaderCompileStatus
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialAnalysis
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMaterialFinding> Findings;
...
USTRUCT(BlueprintType)
struct FTetherPostProcessBlendable
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherPostProcessVolumeInfo
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherPostProcessBlendable> Blendables;
};

/** Summary of an auto_fix_material call (M5-14). */
USTRUCT(BlueprintType)
struct FTetherMaterialAutoFixResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherCreateAssetResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherMaterialGraphOpResult
{
	GENERATED_BODY()
...
struct FTetherMIParamResult
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Material")
	TArray<FTetherMIParamOutcome> Outcomes;
};

/** Metadata for an HLSL snippet shipped in TetherSnippets.ush (M2.5). */
USTRUCT(BlueprintType)
struct FTetherShaderSnippet
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherExpressionPropSet
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FTetherAddExpressionResult
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FTetherTextureRefreshResult
{
	GENERATED_BODY()

	/** 路径是否解析到一个对象；非贴图对象也会为 true，并通过 Error 明确拒绝。 */
	UPROPERTY(BlueprintReadOnly, Category = "Tether|Texture")
	bool bFound = false;
...
/**
 * Material introspection via Tether.
 */
UCLASS()
class TETHER_API UTetherMaterialLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialInstanceInfo GetMaterialInstanceParameters(const FString& MaterialPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialLayerStack GetMaterialInstanceLayerStack(const FString& MaterialInstancePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialLayerStackOpResult SetMaterialInstanceLayerStack(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialLayerStackOpResult CopyMaterialInstanceLayerStack(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialInfo GetMaterialInfo(const FString& MaterialPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static TArray<FTetherMaterialFunctionSummary> ListMaterialFunctions(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialFunctionInfo GetMaterialFunction(const FString& FunctionPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialInstanceChain ListMaterialInstanceChain(const FString& MaterialPath);

	/**
	 * M1-9: UMaterialParameterCollection scalar + vector parameters with their defaults.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialParameterCollectionInfo GetMaterialParameterCollection(const FString& CollectionPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialGraph GetMaterialGraph(const FString& MaterialPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialStats GetMaterialStats(
	 ...
	 * tether execs. See FTetherShaderCompileStatus docstring for the full
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherShaderCompileStatus GetMaterialShaderCompileStatus(
		const FString& MaterialPath,
		const FString& FeatureLevel,
		const FString& Quality);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherCreateAssetResult CreateMaterial(
		const FString& Path,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherCreateAssetResult CreateMaterialInstance(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherAddExpressionResult AddMaterialExpression(
		const FString& MaterialPath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherCreateAssetResult CreateMaterialFunction(
		const FString& Path,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialGraphOpResult ApplyMaterialGraphOps(
		const FString& MaterialPath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialGraphOpResult ValidateMaterialGraphOps(
		const FString& MaterialPath,
		const TArray<FTetherMaterialGraphOp>& Ops);
	 ...
	 * body, output type, and include paths for TetherSnippets.ush (or any other .ush).
	 *
	 * Typical agent flow:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherAddExpressionResult AddCustomExpression(
		const FString& MaterialPath,
		int32 X, int32 Y,
	...
	/**
	 * M2.5-4: Enumerate the snippets declared in TetherSnippets.ush. Fast — reads the file
	 * once, parses the //@snippet headers, returns metadata without function bodies.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static TArray<FTetherShaderSnippet> ListSharedSnippets();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherShaderSnippet GetSharedSnippet(const FString& Name);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMIParamResult SetMIParams(
		const FString& MaterialInstancePath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Texture")
	static FTetherTextureRefreshResult RefreshTextureResource(
	 ...
	 * Uses the same FTetherMIParamSet payload as set_mi_params. Type must be "Scalar"
	 * or "Vector" (the two MPC value kinds). MPC is saved after mutation.
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMIParamResult SetMaterialParameterCollection(
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherCreateAssetResult CreatePostProcessMaterial(
		const FString& Path,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static TArray<FTetherPostProcessVolumeInfo> GetPostProcessState();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialAnalysis AnalyzeMaterial(
		const FString& MaterialPath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialAutoFixResult AutoFixMaterial(
		const FString& MaterialPath,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tether|Material")
	static FTetherMaterialGraphOpResult SetMaterialAttributeLayers(
		const FString& MaterialPath,
		FGuid ExpressionGuid,
